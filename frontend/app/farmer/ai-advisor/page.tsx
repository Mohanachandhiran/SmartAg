...
export default function AIAdvisor() {
  ...
  return (
    <div className="max-w-5xl mx-auto flex flex-col gap-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-border pb-4 bg-card/80 backdrop-blur-md p-6 rounded-3xl border border-border shadow-sm bg-card/80 backdrop-blur-md px-6 py-4 rounded-3xl border border-border inline-block shadow-sm">
        <div>
